  ...
  return (
    <>
      <div
        ...
        className={`fixed top-0 left-0 z-40 w-72 md:w-[30rem] h-screen overflow-y-auto transition-transform ${isOpen ? "translate-x-0" : "-translate-x-full"
          } bg-white `}
        tabIndex="-1"
      ...
      >
        ...
        <div>
          <div className="flex justify-between text-[black] mt-4 mx-4 text-">
            {" "}
            <span className="text-#2a2e2e">0 Comentarios</span>{" "}
            <span>
              <div className="relative">
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="text-black focus:outline-none rounded-lg text-sm px-2 py-2.5 text-center inline-flex items-center"
                    type="button"
                  >
                    Acceder
                    <svg
        ...
        <div className="py-4 overflow-y-auto">
          <div className="flex ">
            ...
            <div>
              <div className="max-w-md mx-auto">
                <form>
                  <div className="">
                    <input
                      type="text"
                      className={`border border-grey-300 rounded-md rounded-br-none rounded-bl-none px-4 py-2 w-full focus:outline-none ${inputFocused ? "h-[100px]" : ""
                        }`}
              ...
              <div className="p-4 grid grid-cols-[100%] sm:grid-cols-[50%,50%]">
                <div>
                  <h6 className="text-[#687a86] uppercase text-[11px] font-bold">
                    Iniciar sesión con
                  </h6>
                ...
                <div>
                  <h6 className="flex flex-row  uppercase text-[12px]">
                    <span>o registrarse con Disqus</span>{" "}
                    <span className="ml-2">
                      {" "}
                      <Image
                        src="/information.png"
          ...
          <div className="grid grid-cols-[100%] sm:grid-cols-[30%,70%]">
            <div>
              <button
            ...
            >
              ...
              <span className="relative top-[-14px]">
                ...
                >
                  <li>
                    <svg
                      class="w-8 h-8 text-white dark:text-white bg-black rounded-xl p-2 mr-2"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                  ...
                  <li>
                    <svg
                      class="w-8 h-8 text-white dark:text-black bg-blue-400 rounded-xl p-2 mr-2"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
          ...
          <div className="w-full">
            <ul className="flex flex-row text-[10px] w-full">
              <li>
          ...
          <div className="w-full">
            <ul className="grid grid-flow-col-[50%,50%] md:grid-flow-col">
              <li>
                <a
